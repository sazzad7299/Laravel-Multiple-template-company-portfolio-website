                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" class="form-control" name="total_home" value="{{ old('total_home') }}">
                            @error('client_name')
                            <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" name="tenure_mix" value="{{ old('tenure_mix') }}">
                            @error('client_name')
                            <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" class="form-control" name="site_size" value="{{ old('site_size') }}">
                            @error('client_name')
                            <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
        ...
        <div class="col-md-4 mb-3">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        <label class="form-label">Planning Approved</label>
