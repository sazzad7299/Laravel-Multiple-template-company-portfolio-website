        ...
        <div class="card-header">
            <div class="row align-items-center">
                ...
                <div class="col-lg-3 col-xl-3">
                    <a href="{{ route('admin.testiominal.create') }}" class="btn btn-primary mb-3 mb-lg-0"><i
                            class="bi bi-plus-square-fill"></i>Add Testimonial</a>
                </div>
            </div>
        </div>
        <div class="card-body">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center gap-3 fs-6">
                                        <a href="{{ route('admin.testiominal.edit', [$post->id]) }}"
                                        ...
                                        <form action="{{ route('admin.testiominal.destroy', [$post->id]) }}" method="post"
