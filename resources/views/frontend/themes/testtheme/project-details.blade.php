...
<!-- Mirrored from duruthemes.com/demo/html/savoye/onepage-dark/project-page.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 15 Jan 2024 05:40:14 GMT -->
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center caption mt-90">
                    <h1>Project Page</h1>
                    <h5><a href="projects.html">Projects</a> / Project Page</h5>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="col-md-8">
                    <div class="row align-items-stretch savoye-photos">
                        <div class="col-md-12 items mb-30">
                            <a href="img/slider/3.jpg" class="d-block savoye-photo-item" data-caption="Project page"
                                data-fancybox="gallery"> <img src="img/slider/3.jpg" alt="" class="img-fluid"> </a>
                        </div>
                        <div class="col-md-6 items mb-30">
                            <a href="img/services/1.jpg" class="d-block savoye-photo-item" data-caption="Project page"
                                data-fancybox="gallery"> <img src="img/services/1.jpg" alt="" class="img-fluid"> </a>
                        </div>
                        <div class="col-md-6 items mb-30">
                            <a href="img/services/2.jpg" class="d-block savoye-photo-item" data-caption="Project page"
                                data-fancybox="gallery"> <img src="img/services/2.jpg" alt="" class="img-fluid"> </a>
                        </div>
                    </div>
                </div>
                <!-- text -->
                <div class="col-md-4">
                    <p>Company non lorem ac erat suscipit bibendum. Nulla facilisi. Sedeuter nunc volutpat, mollis
                        sapien vel, conseyer turpeutionyer masin libero sempe. Fusceler mollis augue sit amet hendrerit
                        vestibulum. Duisteyerionyer venenatis lacus.</p>
                    <p>Villa gravida eros ut turpis interdum ornare. Interdum et malesu they adamale fames ac anteipsu
                        pimsine faucibus. Curabitur arcu site feugiat in torto.</p>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="d-sm-flex align-items-center justify-content-between">
                        ...
                        <div class="projects-prev-next-right"> <a href="project-page.html">Next Project <i
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-3 mb-30">
                    <div class="item abot">
                        <div class="logo mb-15"> <img src="img/logo-light.png" alt=""> </div>
                        <p>Welcome to our Savoye Architecture agency. Viverra tristique justo in duis vitae diam neque
                            niva.</p>
...
<!-- Mirrored from duruthemes.com/demo/html/savoye/onepage-dark/project-page.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 15 Jan 2024 05:40:16 GMT -->
