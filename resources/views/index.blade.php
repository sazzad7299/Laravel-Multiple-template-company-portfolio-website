    ...
    @section('frontend')
        ...
        <header id="home" class="header slider-fade" data-scroll-index="0">
            <div class="owl-carousel owl-theme">
                ...
                <div class="text-left item bg-img" data-overlay-dark="3" data-background="{{asset('frontend/img/slider/2.jpg')}}">
                ...
                <div class="text-left item bg-img" data-overlay-dark="4" data-background="{{asset('frontend/img/slider/3.jpg')}}">
                    <div class="v-middle caption">
                        <div class="container">
                            <div class="row">
                                <div class="col-md-8 mt-30">
        ...
        <div id="parallax-section" class="parallax-header parallax-slider-fade" data-scroll-index="3">
            <div class="owl-carousel owl-theme">
                ...
                <div class="text-left item bg-img" data-overlay-dark="4" data-background="{{asset('frontend/img/slider/1.jpg')}}">
                    <div class="v-middle caption">
                        <div class="container">
                            <div class="row">
                                <div class="col-md-8">
                    ...
                    <div class="col-12 col-md-4 masonry-items">
                        <div class="portfolio-item-wrapp">
                            <div class="portfolio-item">
                                <div class="gallery-masonry-wrapper">
                                    <a class="gallery-masonry-item-img-link d-block savoye-photo-item"
                                        data-fancybox="images" href={{asset('frontend/img/projects/1.jpg')}}"data-caption="Alvar Alto Museum">
                        ...
                        <div class="portfolio-item-wrapp">
                            <div class="portfolio-item">
                                <div class="gallery-masonry-wrapper">
                                    <a class="gallery-masonry-item-img-link d-block savoye-photo-item"
                                        data-fancybox="images" href={{asset('frontend/img/projects/4.jpg')}}
                                        data-caption="European Lard Station"> <img class="img-fluid"
                                            src="{{ asset('frontend/img/projects/4.jpg')}}"alt="">
                                        <div class="gallery-masonry-item-img"></div>
                                        <div class="gallery-masonry-item-content">
                        ...
                        <div class="portfolio-item-wrapp">
                            <div class="portfolio-item">
                                <div class="gallery-masonry-wrapper">
                                    <a class="gallery-masonry-item-img-link d-block savoye-photo-item"
                                        data-fancybox="images" href={{asset('frontend/img/projects/2.jpg')}}"data-caption="Yabroudi Villa"> <img
                    ...
                    <div class="col-12 col-md-4 masonry-items">
                        <div class="portfolio-item-wrapp">
                            <div class="portfolio-item">
                                <div class="gallery-masonry-wrapper">
                                    <a class="gallery-masonry-item-img-link d-block savoye-photo-item"
                                        data-fancybox="images" href={{asset('frontend/img/projects/2.jpg')}}
                                        data-caption="Cultural Complex Centre"> <img class="img-fluid"
                                            src="{{ asset('frontend/img/projects/2.jpg')}}"alt="">
                                        <div class="gallery-masonry-item-img"></div>
                                        <div class="gallery-masonry-item-content">
                        ...
                        <div class="portfolio-item-wrapp">
                            <div class="portfolio-item">
                                <div class="gallery-masonry-wrapper">
                                    <a class="gallery-masonry-item-img-link d-block savoye-photo-item"
                                        data-fancybox="images" href={{asset('frontend/img/projects/5.jpg')}}"data-caption="Dalbourne Villa">
                        ...
                        <div class="portfolio-item-wrapp">
                            <div class="portfolio-item">
                                <div class="gallery-masonry-wrapper">
                                    <a class="gallery-masonry-item-img-link d-block savoye-photo-item"
                                        data-fancybox="images" href={{asset('frontend/img/projects/8.jpg')}}"data-caption="Amman Rotana Hotel">
                    ...
                    <div class="col-12 col-md-4 masonry-items">
                        <div class="portfolio-item-wrapp">
                            <div class="portfolio-item">
                                <div class="gallery-masonry-wrapper">
                                    <a class="gallery-masonry-item-img-link d-block savoye-photo-item"
                                        data-fancybox="images" href={{asset('frontend/img/projects/3.jpg')}}"data-caption="Alvar Alto Museum">
                        ...
                        <div class="portfolio-item-wrapp">
                            <div class="portfolio-item">
                                <div class="gallery-masonry-wrapper">
                                    <a class="gallery-masonry-item-img-link d-block savoye-photo-item"
                                        data-fancybox="images" href={{asset('frontend/img/projects/6.jpg')}}
                                        data-caption="Dance and Music Theatre"> <img class="img-fluid"
                                            src="{{ asset('frontend/img/projects/6.jpg')}}"alt="">
                                        <div class="gallery-masonry-item-img"></div>
                                        <div class="gallery-masonry-item-content">
                        ...
                        <div class="portfolio-item-wrapp">
                            <div class="portfolio-item">
                                <div class="gallery-masonry-wrapper">
                                    <a class="gallery-masonry-item-img-link d-block savoye-photo-item"
                                        data-fancybox="images" href={{asset('frontend/img/projects/7.jpg')}}"data-caption="French Embassy"> <img
